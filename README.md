...
- `mcp-server` 新增 `getProjectRules`、`listRuleVersions`、`getRuleTemplate`、`validateRuleTemplate`、`setActiveRuleVersion`、`getRuleRollout`、`setRuleRollout`、`searchKnowledge` 基础工具
...
- `dashboard` 新增规则中心管理视图，展示生效版本、版本库存、灰度候选版本和灰度比例
