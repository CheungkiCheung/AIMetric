...
const enterpriseMetrics: EnterpriseMetricDefinition[] = [
  ...
  {
    key: 'tab_accepted_lines',
    name: 'Tab 接受行数',
    dimension: 'adoption',
    question: '补全类 AI 能力在编码热路径中贡献了多少被接受代码。',
    formula: '周期内 Tab 补全被接受代码行数',
    dataSources: ['tool-adapter-events'],
    automationLevel: 'medium',
    updateFrequency: 'daily',
    dashboardPlacement: 'effectiveness-management',
    assessmentUsage: 'observe-only',
    antiGamingNote: '不同工具对接受行数的统计口径可能不同，应结合工具类型和采集置信度解释。',
  },
  {
    key: 'mcp_tool_success_rate',
    name: 'MCP 工具成功率',
    dimension: 'adoption',
    question: '员工端 MCP 工具调用是否稳定可用。',
    formula: '成功 MCP 工具调用次数 / MCP 工具调用总次数',
    dataSources: ['mcp-events'],
    automationLevel: 'high',
    updateFrequency: 'near-real-time',
    dashboardPlacement: 'platform-operations',
    assessmentUsage: 'observe-only',
    antiGamingNote: '工具成功率主要用于平台运营诊断，不应直接解释为开发者使用质量。',
  },
  {
    key: 'ai_output_rate',
    name: 'AI 出码率',
  ...
  },
  {
    ...
    name: '缺陷率',
    dimension: 'quality-risk',
    question: '团队交付的需求中沉淀了多少缺陷。',
    formula: '周期内缺陷总数 / 周期内已完成需求数',
    dataSources: ['defect-tracker', 'delivery-tracker'],
    automationLevel: 'medium',
    updateFrequency: 'daily',
    dashboardPlacement: 'engineering-management',
    assessmentUsage: 'team-improvement',
    antiGamingNote: '缺陷率需要按需求复杂度和缺陷等级分层看，不能用简单均值直接排名团队。',
  },
  {
    key: 'escaped_defect_rate',
    name: '生产逃逸缺陷率',
    dimension: 'quality-risk',
    question: '有多少缺陷是在生产阶段才被发现。',
    formula: '生产阶段发现缺陷数 / 缺陷总数',
    dataSources: ['defect-tracker', 'incident-system'],
    automationLevel: 'medium',
    updateFrequency: 'daily',
    dashboardPlacement: 'engineering-management',
    assessmentUsage: 'business-review',
    antiGamingNote: '必须统一“生产发现”口径，避免因为登记习惯不同造成跨团队失真。',
  },
  {
  ...
  },
  {
    ...
    dashboardPlacement: 'engineering-management',
    assessmentUsage: 'team-improvement',
    antiGamingNote: '需要区分主动风险控制回滚和真正线上失败，避免误导团队不敢回滚。',
  },
  {
